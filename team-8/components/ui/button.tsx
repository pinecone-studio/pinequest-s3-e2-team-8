        ...
        <>
          {loading ? (
            <>
              ...
              <span>{loadingText ?? "Ачаалж байна..."}</span>
            </>
          ) : (
            props.children
          )}
